...
class LiveParcel extends StatefulWidget {
  const LiveParcel({super.key});

  @override
  State<LiveParcel> createState() => _LiveParcelState();
}

class _LiveParcelState extends State<LiveParcel> {
  ...
  Future<void> _updateDriverMarkerAndServer(Position position) async {
    ...
    _driverRideController.updateDriverLocation(
      position.latitude,
      position.longitude,
      address,
    );
  ...
  void _setupMarkers() {
    ...
    _markers.add(
      Marker(
        ...
        position: _currentPosition == null
            ? LatLng(
                _driverRideController.parcelResponse.value.data!.pickupLat,
                _driverRideController.parcelResponse.value.data!.pickupLng,
              )
    ...
    _markers.add(
      Marker(
        ...
        position: LatLng(
          _driverRideController.parcelResponse.value.data!.dropoffLat,
          _driverRideController.parcelResponse.value.data!.dropoffLng,
        ),
