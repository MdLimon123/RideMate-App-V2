  ...
  void _setupMarkers() {
    ...
    _markers.add(
      Marker(
        ...
        position: _currentPosition == null
            ? LatLng(
                _driverRideController.tripResponse.value.data!.pickupLat,
                _driverRideController.tripResponse.value.data!.pickupLng,
              )
    ...
    _markers.add(
      Marker(
        ...
        position: LatLng(
          _driverRideController.tripResponse.value.data!.dropoffLat,
          _driverRideController.tripResponse.value.data!.dropoffLng,
        ),
