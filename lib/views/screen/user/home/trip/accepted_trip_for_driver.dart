...
class AcceptedTripForDriver extends StatefulWidget {
  const AcceptedTripForDriver({super.key});

  @override
  State<AcceptedTripForDriver> createState() => _AcceptedTripForDriverState();
}
...
class _AcceptedTripForDriverState extends State<AcceptedTripForDriver> {
  ...
  Widget build(BuildContext context) {
    codeController.text = _rideController.tripResponse.value.data!.slug;
    return Scaffold(
                    ...
                    children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  "${_rideController.tripResponse.value.data!.driver!.vehicleBrand} ${_rideController.tripResponse.value.data!.driver!.vehicleModel}",
                                  style: const TextStyle(
                                    fontSize: 16,
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          filled: true,
                          hint: Text(
                            _rideController.tripResponse.value.data!.slug,
                            style: const TextStyle(
                              fontSize: 16,
                              fontWeight: FontWeight.w400,
                              color: Color(0xFF333333),
