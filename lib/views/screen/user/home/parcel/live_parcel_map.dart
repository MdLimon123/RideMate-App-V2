...
class _LiveParcelMapState extends State<LiveParcelMap> {
  ...
  void initState() {
    ...
    if (_rideController.parcelResponse.value.data!.status != ParcelStatus.STARTED)
      _drawDriverToPickup();
    handleTripStart();
    super.initState();
  }
  ...
  void _setupMarkers() {
    ...
    _markers.add(
      Marker(
        ...
        position: LatLng(
          _rideController.parcelResponse.value.data!.pickupLat,
          _rideController.parcelResponse.value.data!.pickupLng,
        ),
    ...
    _markers.add(
      Marker(
        ...
        position: LatLng(
          _rideController.parcelResponse.value.data!.dropoffLat,
          _rideController.parcelResponse.value.data!.dropoffLng,
        ),
  ...
  void _listenDriverLocation() async {
    _driverRideController.listenDriverLocation(
      id: _rideController.parcelResponse.value.data!.driver!.id,
  ...
  void handleTripStart() async {
    ...
    await _driverRideController.startParcel();
